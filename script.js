document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function showError(input, message) {
            ...
            errorMessages[input.name] = errorElement;
        }

        function clearError(input) {
            input.style.borderColor = '';
            if (errorMessages[input.name]) {
                errorMessages[input.name].remove();
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dec666c1-5cc7-47ef-a7b7-ac607c3a5d09',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dec666c1-5cc7-47ef-a7b7-ac607c3a5d09';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dec666c1-5cc7-47ef-a7b7-ac607c3a5d09';
